...
import { ReactComponent as ContactImg } from '../Assets/casual-life-3d-girl-talking-on-retro-phone-and-smiling_result.svg';
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    if (name.trim() && email.trim() && subject.trim() && message.trim()) {
      ...
      emailjs
        ...
        .catch((error) => {
          setSpin(false);
          setAlert('Huh  An Error Ocurred ' + error.message + ' !!!');
  ...
  return (
    <section
      className={`md:min-h-screen mt-28 lg:mt-0 text-white px-3 flex items-center justify-center max-w-7xl lg:px-10 transition-all duration-700 ease-in-out`}
    >
      <div className="">
          ...
          <div className="w-full lg:w-5/12 mb-32 md:mb-40 lg:mb-16 mt-4">
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <label className="absolute text-sm text-zinc-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-zinc-700 rounded px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-2">
                  {' '}
                  Email Address
                </label>
              </div>
              ...
              <div className="relative ">
                ...
                />
                <label className="absolute text-sm text-zinc-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-zinc-700 rounded px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-8 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-2">
                  {' '}
                  Message
                </label>
              </div>
